...
// //   const { d_no,e_msg } = req.query;
// //   const { start,end } = req.query;
// //   //首先判断是否激活了ok按钮
// //   if(d_no!=="1"&&e_msg==="1"){//当传入的仅d_no不为空
// //     console.log("gui1");
// //     if(start==="1"&&end==="1"){
// //       const [rows] = await connection1.execute(`SELECT * FROM t_error_history WHERE d_no = '${d_no}' AND type='${type}'`);
// //       res.send(""+rows.length);//返回长度
// //     }
// //     else if(start==="end"&&end!=="1"){
// //       const formatTime = (timeStr) => new Date(timeStr).toISOString().slice(0, 19).replace('T', ' ');
// //       const formattedEnd = formatTime(end);
// //       const [rows] = await connection1.execute(`SELECT * FROM t_error_history WHERE d_no = '${d_no}' AND type='${type}' AND c_time < '${formattedEnd}'`);
// //       res.send(""+rows.length);//返回长度
// //     }
// //     else{
// //       const formatTime = (timeStr) => new Date(timeStr).toISOString().slice(0, 19).replace('T', ' ');
// //       const formattedStart = formatTime(start);
// //       const formattedEnd = formatTime(end);
// //       const [rows] = await connection1.execute(`SELECT * FROM t_error_history WHERE d_no = '${d_no}' AND type='${type}' AND c_time BETWEEN '${formattedStart}' AND '${formattedEnd}'`);
// //       res.send(""+rows.length);//返回长度
// //     }
// //   }
...
// //     console.log("gui");
// //     if(start==="1"&&end==="1"){
// //       const [rows] = await connection1.execute(`SELECT * FROM t_error_history WHERE e_msg = '${e_msg}' AND type='${type}'`);
// //       res.send(""+rows.length);//返回长度
// //     }
// //     else if(start==="end"&&end!=="1"){
// //       const formatTime = (timeStr) => new Date(timeStr).toISOString().slice(0, 19).replace('T', ' ');
// //       const formattedEnd = formatTime(end);
// //       const [rows] = await connection1.execute(`SELECT * FROM t_error_history WHERE e_msg = '${e_msg}' AND type='${type}' AND c_time<'${formattedEnd}'`);
// //       res.send(""+rows.length);//返回长度
// //     }
// //     else {
// //       const formatTime = (timeStr) => new Date(timeStr).toISOString().slice(0, 19).replace('T', ' ');
// //       const formattedStart = formatTime(start);
// //       const formattedEnd = formatTime(end);
// //       const [rows] = await connection1.execute(`SELECT * FROM t_error_history WHERE e_msg = '${e_msg}' AND type='${type}' AND c_time BETWEEN '${formattedStart}' AND '${formattedEnd}'`);
// //       res.send(""+rows.length);//返回长度
// //     }
...
// //     if(start==="1"&&end==="1"){
// //       console.log("gui2");
// //       const [rows] = await connection1.execute(`SELECT * FROM t_error_history WHERE d_no = '${d_no}' AND e_msg='${e_msg}' AND type='${type}'`);
// //       res.send(""+rows.length);//返回长度
// //     }
// //     else if(start==="end"&&end!=="1"){
// //       const formatTime = (timeStr) => new Date(timeStr).toISOString().slice(0, 19).replace('T', ' ');
// //       const formattedEnd = formatTime(end);
// //       console.log("gui2");
// //       const [rows] = await connection1.execute(`SELECT * FROM t_error_history WHERE d_no = '${d_no}' AND e_msg='${e_msg}' AND type='${type}' AND c_time < '${formattedEnd}'`);
// //       res.send(""+rows.length);//返回长度
// //     }
// //     else {
// //       const formatTime = (timeStr) => new Date(timeStr).toISOString().slice(0, 19).replace('T', ' ');
...
// //       const formattedEnd = formatTime(end);
// //       console.log("gui2");
// //       const [rows] = await connection1.execute(`SELECT * FROM t_error_history WHERE d_no = '${d_no}' AND e_msg='${e_msg}' AND type='${type}' AND c_time BETWEEN '${formattedStart}' AND '${formattedEnd}'`);
// //       res.send(""+rows.length);//返回长度
// //     }
// //   }
// // })
